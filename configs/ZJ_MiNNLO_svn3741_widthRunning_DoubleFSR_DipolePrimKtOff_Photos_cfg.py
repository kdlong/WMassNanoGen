...
# with command line options: Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKtOff_Photos_cff.py --fileout file:ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKtOff_Photos.root --mc --eventcontent LHE,NANOAODSIM --datatier LHE,NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKtOff_Photos_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 30 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKtOff_Photos_cff.py nevts:30'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKtOff_Photos.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKtOff_Photos_inNANOAODSIM.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc700/13TeV/powheg/Vj_NNLOPS/Zj_slc6_amd64_gcc700_CMSSW_10_2_16_ZJToMuMu-suggested-nnpdf31-ncalls-doublefsr-powheg-MiNNLO3-svn3741-ew-rwl4-j200-st2fix-ana-reducedrwl.tgz'),
...
# Schedule definition
process.schedule = cms.Schedule(process.lhe_step,process.generation_step,process.genfiltersummary_step,process.nanoAOD_step,process.endjob_step,process.LHEoutput_step,process.NANOAODSIMoutput_step)
