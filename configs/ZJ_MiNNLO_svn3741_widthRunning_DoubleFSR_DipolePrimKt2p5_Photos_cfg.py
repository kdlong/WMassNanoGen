...
# with command line options: Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos_cff.py --fileout file:ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 30 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos_cff.py nevts:30'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc700/13TeV/powheg/Vj_NNLOPS/Zj_slc6_amd64_gcc700_CMSSW_10_2_16_ZJToMuMu-suggested-nnpdf31-ncalls-doublefsr-powheg-MiNNLO3-svn3741-ew-rwl4-j200-st2fix-ana.tgz'),
