...
# with command line options: Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGEN-00022-fragment.py --fileout file:SMP-RunIISummer20UL16wmLHEGEN-00022.root --mc --eventcontent NANOAODGEN --datatier NANOAODSIM --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN,NANOGEN --nThreads 1 --geometry DB:Extended --era Run2_2016 --python_filename SMP-RunIISummer20UL16wmLHEGEN-00022_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 70
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGEN-00022-fragment.py nevts:70'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL16wmLHEGEN-00022.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc700/13TeV/powheg/Vj_NNLOPS/Wj_slc6_amd64_gcc700_CMSSW_10_2_23_WplusJToMuNu-suggested-nnpdf31-ncalls-doublefsr-q139-ckm-powheg-MiNNLO31-svn3756-ew-rwl5-j200-st2fix-ana-hoppetweights-ymax20-newgrids.tgz'),
