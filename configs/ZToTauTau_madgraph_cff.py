...
# with command line options: Configuration/WMassNanoGen/python/ZJ_MiNNLO_fixedGrid0_CP5_Photos_cff.py --fileout file:test.root --mc --eventcontent NANOAODSIM --filein file:test.lhe --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJ_MiNNLO_fixedGrid0_CP5_Photos_cfg.py -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/ZJ_MiNNLO_fixedGrid0_CP5_Photos_cff.py nevts:10'),
...
process.lhe_step = cms.Path(process.source)
