...
# with command line options: Configuration/WMassNanoGen/python/WmJ_MiNNLO_svn3741_Photos_PrimKtOff_Wimpy_cff.py --fileout file:WmJ_MiNNLO_svn3741_Photos_PrimKtOff_Wimpy.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WmJ_MiNNLO_svn3741_Photos_PrimKtOff_Wimpy_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WmJ_MiNNLO_svn3741_Photos_PrimKtOff_Wimpy_cff.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WmJ_MiNNLO_svn3741_Photos_PrimKtOff_Wimpy.root'),
