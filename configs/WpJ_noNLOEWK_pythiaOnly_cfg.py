...
# with command line options: Configuration/WMassNanoGen/python/WpJ_noNLOEWK_pythiaOnly_cff.py --fileout file:WpJ_noNLOEWK_pythiaOnly.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WpJ_noNLOEWK_pythiaOnly_cfg.py -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WpJ_noNLOEWK_pythiaOnly_cff.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WpJ_noNLOEWK_pythiaOnly.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc630/13TeV/test/W_ew-BMNNP_slc6_amd64_gcc630_CMSSW_9_3_0_my_marc_WplusElNu_NLOQCD1_NLOEWK0.tgz'),
