...
# with command line options: Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_Photos_cff.py --fileout file:ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_Photos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_Photos_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_Photos_cff.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLO_svn3741_widthRunning_DoubleFSR_Photos.root'),
