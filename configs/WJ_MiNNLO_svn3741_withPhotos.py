...
# with command line options: Configuration/WMassNanoGen/python/WJ_MiNNLOUpdate_svn3741_withPhotos.py --fileout file:WJ_MiNNLOUpdate_svn3741_withPhotos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WJ_MiNNLOUpdate_svn3741_withPhotos.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WJ_MiNNLOUpdate_svn3741_withPhotos.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WJ_MiNNLOUpdate_svn3741_withPhotos.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc700/13TeV/powheg/Vj_NNLOPS/Wj_slc6_amd64_gcc700_CMSSW_10_2_16_WplusJToMuNu-minnlo3-suggested-nnpdf31-ncalls-ckm-powheg-MiNNLO-svn3741-ew-rwl3-j20-st2fix-reducedrwl.tgz'),
