...
# with command line options: Configuration/WMassNanoGen/python/WJ_MiNNLO_withPhotos_cff.py --fileout file:WJ_MiNNLO_withPhotos_NanoGen.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WJ_MiNNLO_withPhotos_cfg.py -n 500 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WJ_MiNNLO_withPhotos_cff.py nevts:500'),
