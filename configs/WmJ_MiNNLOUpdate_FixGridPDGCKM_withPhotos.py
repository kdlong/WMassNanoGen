...
# with command line options: Configuration/WMassNanoGen/python/WmJ_MiNNLOUpdate_FixGridPDGCKM_withPhotos.py --fileout file:WmJ_MiNNLOUpdate_FixGridPDGCKM_withPhotos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WmJ_MiNNLOUpdate_FixGridPDGCKM_withPhotos.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WmJ_MiNNLOUpdate_FixGridPDGCKM_withPhotos.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WmJ_MiNNLOUpdate_FixGridPDGCKM_withPhotos.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc700/13TeV/powheg/Vj_NNLOPS/Wj_slc6_amd64_gcc700_CMSSW_10_2_16_WminusJToMuNu-reference-nnpdf31-cbthr0-fixedgrid0-ncalls-ckm-powheg-MiNNLO-svn-ew-rwl3-j200-st2fix.tgz'),
