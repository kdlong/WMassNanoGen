...
# with command line options: Configuration/WMassNanoGen/python/WJ_MiNNLOUpdate_withPhotos_cff.py --fileout file:WJ_MiNNLOUpdate_withPhotos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WJ_MiNNLOUpdate_withPhotos_cfg.py -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WJ_MiNNLOUpdate_withPhotos_cff.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WJ_MiNNLOUpdate_withPhotos.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc700/13TeV/powheg/Vj_NNLOPS/Wj_slc6_amd64_gcc700_CMSSW_10_2_16_WPlusJToMuNu-reference-nnpdf31-cbthr0-powheg-MiNNLO-svn-reducedrwl.tgz'),
