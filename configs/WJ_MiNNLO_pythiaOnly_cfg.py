...
# with command line options: Configuration/WMassNanoGen/python/WJ_MiNNLO_pythiaOnly_cff.py --fileout file:WJ_MiNNLO_pythiaOnly.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WJ_MiNNLO_pythiaOnly_cfg.py -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WJ_MiNNLO_pythiaOnly_cff.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WJ_MiNNLO_pythiaOnly.root'),
