...
# with command line options: Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3756_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos_cff.py --fileout file:ZJ_MiNNLO_svn3756_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos.root --mc --eventcontent LHE,NANOAODSIM --datatier LHE,NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJ_MiNNLO_svn3756_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 50 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/ZJ_MiNNLO_svn3756_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos_cff.py nevts:50'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLO_svn3756_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLO_svn3756_widthRunning_DoubleFSR_DipolePrimKt2p5_Photos_inNANOAODSIM.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'BeamRemnants:primordialKTsoft = 2.50478', 
            'BeamRemnants:primordialKThard = 2.50478', 
