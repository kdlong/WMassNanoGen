...
# with command line options: Configuration/WMassNanoGen/python/ZJ_MiNNLO_defaultConfigNNPDF31_cbthr0_update2020_03_05_withPhotos_cff.py --fileout file:ZJ_MiNNLO_UpdateNNPDF31_cbthr0_withPhotos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJ_MiNNLO_defaultConfigNNPDF31_cbthr0_update2020_03_05_withPhotos_cfg.py -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/ZJ_MiNNLO_defaultConfigNNPDF31_cbthr0_update2020_03_05_withPhotos_cff.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLO_UpdateNNPDF31_cbthr0_withPhotos.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc700/13TeV/powheg/Vj_NNLOPS/Zj_slc6_amd64_gcc700_CMSSW_10_2_16_ZJToMuMu-reference-nnpdf31-cbthr0-powheg-MiNNLO-svn-reducedrwl.tgz'),
