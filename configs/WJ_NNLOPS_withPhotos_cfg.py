...
# with command line options: Configuration/WMassNanoGen/python/WJ_NNLOPS_withPhotos_cff.py --fileout file:WJ_NNLOPS_withPhotos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WJ_NNLOPS_withPhotos_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 10 --no_exec
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WJ_NNLOPS_withPhotos.root'),
