...
# with command line options: Configuration/WMassNanoGen/python/WmJ_MiNNLO_svn3741_Photos_cff.py --fileout file:WmJ_MiNNLO_svn3741_Photos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/WmJ_MiNNLO_svn3741_Photos_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 30 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/WmJ_MiNNLO_svn3741_Photos_cff.py nevts:30'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WmJ_MiNNLO_svn3741_Photos.root'),
