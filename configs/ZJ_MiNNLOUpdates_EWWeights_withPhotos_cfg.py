...
# with command line options: Configuration/WMassNanoGen/python/ZJ_MiNNLOUpdates_EWWeights_withPhotos_cff.py --fileout file:ZJ_MiNNLOUpdates_EWWeights_withPhotos.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/ZJ_MiNNLOUpdates_EWWeights_withPhotos_cfg.py -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/WMassNanoGen/python/ZJ_MiNNLOUpdates_EWWeights_withPhotos_cff.py nevts:10'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:ZJ_MiNNLOUpdates_EWWeights_withPhotos.root'),
