...
config.JobType.psetName = '../configs/ZJ_MiNNLO_mWPilot_CP5_Photos_cfg.py'

config.Data.outputPrimaryDataset = 'ZJToMuMu_mWPilot_TuneCP5_13TeV-powheg-MiNNLO-pythia8-photos'
